...
//   const handleBookAppointment = (adv) => {
//     setSelectedAdvocate(adv);
//     if (!userRegistered) {
//       setShowRegister(true); // show only register form
//       setShowAppointment(false); // ensure appointment form not open
//     } else {
//       setShowAppointment(true); // show appointment form directly
//     }
//   };
...
//     }
//     // if cross clicked (registered=false), do nothing
//   };
