...
const Branches = () => {
    ...
    return (
        ...
        <div className='mb-16 md:mb-60'>
            <h1 className='text-4xl font-bold text-center my-6 text-green-300'>We Are Available In 8 Districs</h1>
    ...
    <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor" >
     ...
     <input type="search" className="grow" placeholder="Search" name='location'/>
            ...
            <div className='w-full h-100 px-16 '>
